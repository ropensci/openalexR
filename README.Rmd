...
[![R-CMD-check](https://github.com/massimoaria/openalexR/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/massimoaria/openalexR/actions/workflows/R-CMD-check.yaml) `r badger::badge_cran_download("openalexR", "grand-total")` [![CRAN status](https://www.r-pkg.org/badges/version/openalexR)](https://CRAN.R-project.org/package=openalexR)
...
We show a few examples before.

### Works

**Goal**: Download all information about certain publications (given DOIs).
...
**Goal**: Download all works published by a set of authors (given ORCIDs).
...
This may be a little confusing, but again, because this is a different entity (**authors** instead of **works**), we have to use a [different set of filters](https://docs.openalex.org/api/get-lists-of-entities/filter-entity-lists#authors-filters).
...
We can also filter by other [filters](https://docs.openalex.org/api/get-lists-of-entities/filter-entity-lists#authors-filters) such as `display_name` and `has_orcid`:
