...
OpenAlex offers (limited) support for full-text N-grams of Work entities (these have IDs starting with `"W"`). Given a vector of work IDs, `oa_ngrams()` returns a dataframe of N-gram data (in the `ngrams` list-column) for each work:
