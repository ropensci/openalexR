...
Use `doi` as a filter (either the canonical form with <https://doi.org/> or without):
...
_Learn more_ about [supported filters for each entity](https://docs.openalex.org/api/get-lists-of-entities/filter-entity-lists).
...
**Goal**: track the popularity of _Biology_ concepts over time.
