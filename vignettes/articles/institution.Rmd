...
We first need to find the [openalex.id](https://docs.openalex.org/about-the-data/institution#id) for University of Pennsylvania.
...
We will use the first ror, <https://ror.org/00b30xv10>, as one of the filters for our query.
...
open_access <- oa_fetch(
  entity = "works",
  institutions.ror = "https://ror.org/00b30xv10",
