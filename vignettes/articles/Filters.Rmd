...
See the [original documentation](https://docs.openalex.org/api/get-lists-of-entities/filter-entity-lists) from Open Alex.
...
| `host_venue.issn`                       | \"2167-8359\"                                                                              |
| `host_venue.license`                    | \"cc-by\"                                                                                  |
| `host_venue.publisher`                  | \"PeerJ\"                                                                                  |
